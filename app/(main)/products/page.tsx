            ...
            >
              ...
              <Box>
                ...
                <Flex justify="space-between">
                  <Text>{priceRange[0]} ETB</Text>
                  <Text>{priceRange[1]} ETB</Text>
                </Flex>
              </Box>
            </MotionBox>
          </Box>
            ...
            >
              {filteredProducts.map((product) => (
                  <MotionBox key={product.id} variants={itemVariants}>
                    {/* Clickable card - use router.push instead of nested Link to avoid nested anchors */}
                    <MotionBox
                      borderWidth="1px"
                      borderRadius="lg"
                      overflow="hidden"
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            ...
            <Box>
              ...
              <RangeSlider min={0} max={1500} step={30} value={priceRange} onChange={(val) => setPriceRange(val)} mb={4}>
                <RangeSliderTrack>
                  <RangeSliderFilledTrack bg="brand.500" />
                </RangeSliderTrack>
                <RangeSliderThumb index={0} />
